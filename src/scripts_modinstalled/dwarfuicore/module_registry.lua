...
MODULES = {
    ...
    {name='dwarfuicore/input_event/event_deriver', contract='InputEventDeriver', contract_type='table'},
    {name='dwarfuicore/input_event/pointer_obstruction_classifier', contract='PointerObstructionClassifier', contract_type='table'},
    {name='dwarfuicore/input_event/gui_view_pointer_obstruction_classifier', contract='GuiViewPointerObstructionClassifier', contract_type='table'},
    {name='dwarfuicore/input_event/native_ui_pointer_obstruction_classifier', contract='NativeUiPointerObstructionClassifier', contract_type='table'},
    {name='dwarfuicore/input_event/ui_obstruction_resolver', contract='InputEventUiObstructionResolver', contract_type='table'},
    {name='dwarfuicore/input_event/ui_root_collector', contract='InputEventUiRootCollector', contract_type='table'},
    ...
    {name='dwarfuicore/user_prompt/value', contract='MapLocationPromptOptions', contract_type='table'},
    {name='dwarfuicore/user_prompt/indicator', contract='NativeIndicatorAdapter', contract_type='table'},
    {name='dwarfuicore/user_prompt/service', contract='service', contract_type='table'},
    ...
    {name='dwarfuicore/user_prompt/input_consumer', contract='UserPromptInputConsumer', contract_type='table'},
    {name='dwarfuicore/user_prompt/renderer', contract='UserPromptRenderer', contract_type='table'},
    ...
    {name='dwarfuicore/user_prompt/runtime', contract='runtime', contract_type='table'},
