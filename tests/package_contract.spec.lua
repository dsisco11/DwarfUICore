...
describe('DwarfUICore package contract', function()
    ...
    it('owns shared infrastructure under the dwarfuicore namespace', function()
        local shared_modules = {
            ...
            'input_event/pointer_obstruction_classifier.lua',
            'input_event/gui_view_pointer_obstruction_classifier.lua',
            'input_event/native_ui_pointer_obstruction_classifier.lua',
            'input_event/ui_obstruction_resolver.lua',
            'input_event/ui_root_collector.lua',
