...
local text_path = 'src/scripts_modinstalled/dwarfuicore/text.lua'
local tooltip_path = 'src/scripts_modinstalled/dwarfuicore/tooltip/renderer.lua'
local Policy
...
describe('DwarfUICore tooltip renderer', function()
    ...
    it('contains no SoulSearch diagnostics or logging surface', function()
        local file = assert(io.open(repo_root ..
            '/src/scripts_modinstalled/dwarfuicore/tooltip/renderer.lua', 'rb'))
